    ...
    return (
        <div className='container'>
            ...
            <div className='card-container'>
                ...
                <a className='text-decoration-none' href="https://contact-manager-oe9x.onrender.com/" target="_blank">
                ...
                <div className='project-card'>
                    <a className='text-decoration-none' href="https://instaclone-frontend-5o0w.onrender.com/" target="_blank">
                ...
                <div className='project-card'>
                    <a className='text-decoration-none' href="https://purushothama-fub-game.onrender.com" target="_blank">
                ...
                <div className='project-card'>
                    <a className='text-decoration-none' href="https://purushothama-todo-application.onrender.com" target="_blank">
                    <h1 className="text-white text-center">Redux ToDo App</h1>
                    <img className='hide-image' src={require("../Assets/Todo-redux-app.png")} alt=" Contact-manager" />
                    <p className='hide text-white'>Appplication allows to user, register, login,  logout and add time shedules and filter their near pending due dates, expired due dates and important works</p>
                    </a>
                </div>
            </div>
